...
public class DeleteUsers2Activity extends AppCompatActivity {
    ...
    DatabaseReference mUsersDatabase = database.getReference().child("CarroHistorico");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_users2);

        User_id = getIntent().getStringExtra("user_id");


        mUsersDatabase = FirebaseDatabase.getInstance().getReference().child("CarroHistorico").child(User_id);
...
//------------------------------------------------------------
        ...
        Intent IntentEditar = new Intent(DeleteUsers2Activity.this, MainActivity.class);
